package UploadSample::Web;
use strict;
use warnings;
use utf8;
use parent qw/UploadSample Amon2::Web/;
use File::Spec;

# dispatcher
use UploadSample::Web::Dispatcher;
sub dispatch {
    return (UploadSample::Web::Dispatcher->dispatch($_[0]) or die "response is not generated");
}
